...
print("[8]MailSpam - Спам сообщений на электронную почту")
print("-----DDOS ATTACK-----")
print("[9]Doser - утилита для DoS Аттак")
print("-----Prank-----")
print("[10]DCP - Утилита для пранка читать подробнее после запуска")
print("-----Others-----")
print("[11]Bot Bilder - Утилита поможет сделать ботов для ВК")
print(" ")
...
while True:
    ...
    if num == (1) :
        ...
        print (Fore.GREEN + 'Запуск MailSpam...')
        os.system('clear')
        os.chdir('DH')
        os.system('python3 MailSpam.py')
    elif num == (9):
        print (Fore.GREEN + 'Запуск VKTOOL...')
        os.system('clear')
        os.chdir('DH')
